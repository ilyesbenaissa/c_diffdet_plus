...
from .latent_embedding import LatentEmbedding, CrossAttention
...
class DynamicHead(nn.Module):
    ...
    def forward(self, features, init_bboxes, t, init_features, global_context=None):
        ...
        for head_idx, rcnn_head in enumerate(self.head_series):
            class_logits, pred_bboxes, proposal_features = rcnn_head(features, bboxes, proposal_features, self.box_pooler, time, global_context)
...
class RCNNHead(nn.Module):
    ...
    def forward(self, features, bboxes, pro_features, pooler, time_emb, global_context=None):
        """
        ...
        if global_context is not None:
            ...
            pro_features = self.cross_attn(pro_features, global_context, global_context)
