...
# Define the paths to your dataset relative to your project folder
DATASET_ROOT = "datasets/carDD"
ANNOTATIONS_ROOT = os.path.join(DATASET_ROOT, "annotations")
TRAIN_JSON = os.path.join(ANNOTATIONS_ROOT, "train.json")
TRAIN_PATH = os.path.join(DATASET_ROOT, "train")
VAL_JSON = os.path.join(ANNOTATIONS_ROOT, "val.json")
VAL_PATH = os.path.join(DATASET_ROOT, "val")
TEST_JSON = os.path.join(ANNOTATIONS_ROOT, "test.json")
TEST_PATH = os.path.join(DATASET_ROOT, "test")
# Register the training dataset
# This function tells Detectron2 that "carDD_train" means to use your train.json and train image folder.
...
# This function tells Detectron2 that "carDD_val" means to use your val.json and val image folder.
register_coco_instances(
    "carDD_val",
    {},
    VAL_JSON,
